...
public class CpmFileSystemTest {
    ...
    private static final Logger LOGGER = LoggerFactory.getLogger(CpmFileSystemTest.class);
    ...
    public void createFromExistingFile() throws IOException {
        ...
        CpmFileSystem fs1 = CpmFileSystem.fromByteArray(
                Util.fromInputStream(CpmFileSystemTest.class.getResourceAsStream("/cpm-1.raw")),
                parameters);
